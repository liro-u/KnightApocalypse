...
class FallingObjectGenerator extends DE.GameObject {
    constructor({spawnLimitX1, spawnLimitX2, delay, speed, lifetime, fallingObjectsParams, ...otherParams}) {
        super({
            ...otherParams
        });
    ...
    createFallingObject = () => {
        if (this.generating) {
            ...
            const {spriteRendererParams, name, ...fallingObjectParams} = this.fallingObjectsParams[index]
            ...
            setTimeout(this.createFallingObject, this.delay);
        }
    }
