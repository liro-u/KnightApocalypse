...
class FallingObject extends DE.GameObject {
    constructor({ref, radiusCollision = 50, speed = 10, lifetime = 2000, automatisms = [], scale = 3, spriteRendererParams, ...otherParams}) {
        super({
            y: -1000,
            automatisms: [
            ...
            renderers: [
                new DE.SpriteRenderer({...spriteRendererParams}),
            ],
            scale,
            ...otherParams
        });
